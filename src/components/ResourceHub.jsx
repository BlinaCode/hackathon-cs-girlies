    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {filteredResources.map((res, idx) => {
          ...
          return (
            <div key={res.id} className="relative p-6 sm:p-8 min-h-[440px]">
              <div
                className="absolute inset-0 bg-gradient-to-br from-green-500 to-green-700"
                style={{ borderRadius: "44% 56% 61% 39% / 49% 44% 56% 51%" }}
              >
          ...
          style={{ background: 'linear-gradient(135deg, #FDF6E2, #EAD5A0)' }}
        ><div className="space-y-3">
            ...
            <p className="text-xs text-bluey-900/80 leading-relaxed">
              {res.summary}
            </p>
          </div>
        ...
        <div className="absolute -top-4 -left-2 text-4xl drop-shadow-lg z-10">🌴</div>
        <div className="absolute -top-2 left-8 text-3xl drop-shadow-lg z-10 -scale-x-100">🌴</div>
        <div className="absolute -bottom-3 -right-3 text-4xl drop-shadow-lg z-10">🌴</div>
        <div className="absolute bottom-4 -right-1 text-2xl drop-shadow-lg z-10 -scale-x-100">🌴</div>
        <div className="absolute top-1/3 -right-2 text-xl drop-shadow z-10">🪨</div>
        <div className="absolute bottom-8 -left-3 text-lg drop-shadow z-10">🪨</div>
      </div>
      </div>
    );
  })}
